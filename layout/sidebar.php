...
<div id="head-nav" class="navbar navbar-default navbar-fixed-top">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="#"><span>KEUANGAN </span></a>
		</div>
						...
						if (isset($_SESSION['level'])) {
							if ($_SESSION['level'] == 'admin') {
								...
								<li><a href="#"><i class="fa fa-pencil"></i><span> Keberangkatan</span></a>
									<ul class="sub-menu">
										<li><a href="?keberangkatan=Penumpang"><span class="fa fa-asterisk"></span>
												Penumpang</a></li>
										<li><a href="?keberangkatan=Barang"><span class="fa fa-asterisk"></span> Barang</a></li>
										<li><a href="?keberangkatan=Surat"><span class="fa fa-asterisk"></span> Surat Jalan</a>
										</li>
									</ul>
								</li>
								<li><a href="#"><i class="fa fa-pencil"></i><span> Laporan</span></a>
									<ul class="sub-menu">
										<li><a href="?laporan=Keuangan"><span class="fa fa-asterisk"></span> Laporan
												Pendapatan</a></li>
									</ul>
								</li>
								<?php
