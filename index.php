...
<style>
	body.texture {
		background: url('assets/images/bus.jpeg') no-repeat center center fixed;
	...
	<div id="cl-wrapper" class="login-container">
		...
		<div class="middle-login">
			<div class="block-flat">
				<div class="header">
					<h3 class="text-center">CV Travel Sokan Bangko</h3>
				</div>
				<div>
					<form style="margin-bottom: 0px !important;" class="form-horizontal" action="core/login.php"
						method="post">
						<div class="content">
						...
						<div class="foot">
							<button class="btn btn-primary" data-dismiss="modal" type="submit" name="signin"><span
